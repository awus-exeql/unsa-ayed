...
public class Canvas extends JPanel {
	 ...
	 * los v�rtices de los tri�ngulos internos.
	 * nivel (>= 0) es el par�metro de recursi�n (base case: nivel 0)
	 */
	...
	/**
	 * dibujarCuadro()---dibuja recursivamente un patr�n
	 * de cuadros anidados
	 * con la esquina superior izq en (locX, locY) 
	 * y con la longitud dada por lado
	 * nivel (>= 0) es el par�metro de recursi�n (caso base: nivel 0)
